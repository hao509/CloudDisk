...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `op` (
  `opid` int(20) NOT NULL AUTO_INCREMENT COMMENT '操作id',
  `opmethod` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '操作方式',
  `opdate` datetime NOT NULL COMMENT '操作时间',
  `opres` varchar(255) NOT NULL COMMENT '操作结果',
  `opip` varchar(50) NOT NULL COMMENT '操作ip',
...
INSERT INTO `op` VALUES (1,'POST','2023-05-07 14:54:01','Result(code=200, message=请求成功, data=UserRoleDto(id...}','169.254.77.166');
...
INSERT INTO `role` VALUES ('yx','user'),('zzc','user'),('zzh','admin'),('zzz','user');
...
INSERT INTO `user` VALUES ('yx','yx','73fee192744f842a611a5ec336459f5c','yx','18188888888',1,'524,288,000'),('zzc','zzc','e10adc3949ba59abbe56e057f20f883e','zzc','12121212121',1,'524,288,000'),('zzh','zzh','e10adc3949ba59abbe56e057f20f883e','zzh','18188482067',1,'524,288,000'),('zzz','zzz','e10adc3949ba59abbe56e057f20f883e','zzz','13111111111',1,'524,288,000');
...
-- Dump completed on 2023-05-07 14:54:15
